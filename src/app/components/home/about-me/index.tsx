          ...
          <div className="container">
            ...
            <div className="pt-10 xl:pt-16 flex gap-10 items-center justify-between">
              ...
              <div className="w-full lg:max-w-2xl flex-1">
                <p>
                I’m a Full Stack Developer with 3.5 years of experience building scalable applications using Java, Spring Boot, Angular, React, and Next.js. I have worked on multiple end-to-end projects involving REST APIs, microservices, frontend UI/UX development, and cloud-ready architectures. I’m passionate about writing clean, maintainable code, solving real-world problems, and delivering high-quality features with strong attention to detail. I actively use Git/GitHub for version control and collaborative development.
                </p>

                <div className="grid grid-cols-3 py-10 xl:py-16 gap-5 border-b border-mistGray">
                  {[
                    { count: "3.5", label: "Years of experience" },
